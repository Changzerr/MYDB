...
public class TransactionManagerTest {
    ...
    public void testMultiThread() {
        tmger = TransactionManager.create("E:\\学习\\web后端\\myDB\\myDB\\src\\test\\resources\\tmp\\tranmger_test");
        ...
        //tmger.close();
        assert new File("E:\\学习\\web后端\\myDB\\myDB\\src\\test\\resources\\tmp\\tranmger_test.xid").delete();
    }
